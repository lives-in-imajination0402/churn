...
Original file is located at
    https://colab.research.google.com/drive/1gfj5tLMt81gZPpY613SK2F7Vs7Y7QcTz
"""
...
#doing correlation to see the association
corr = data.corr()
...
#doing statistical test to see if the features are in significant way
...
k = 5  # Number of folds (you can adjust this value)
...
# Create and fit a QDA model on the training data
...
#feature selection,fitting the model and improving the model by hyperparameter tuning
